...
public class Adaboost {
	...
	private HashSet<String> important_words;//
	 ...
	 * we check the sign of the result,if it's negtive then we have spamm,if it's positive then we have ham!Of course we do
	 ...
	 *  definately not 1.So we'll divide each weight by 14 and see the result. 1/14=0.071 , 3/14=0.214 , 10/14 = 0.714.
