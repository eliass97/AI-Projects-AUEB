...
public class Data {
	...
	/*This is H(C).It counts how many emails are spamm and ham,and then divides these by the size of the emails.
	 * THis gives us the chance of a mail being spamm and a mail being ham,then we use this chance(let's say x)
	 ...
	 * At the beggining in the first for loop we calculate how many times we can find
